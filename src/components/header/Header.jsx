...
const [anim, setAnim] = useState(false);
    ...
    return (
        <>
            <div className={`flex flex-col lg:flex-row items-center lg:justify-center gap-7 lg:gap-4 h-fit lg:h-2/4 w-screen mb-8 lg:mb-0 mt-20 md:mt-64 lg:mt-44 bg-gradient-to-b from-black via-purple-950 ${styles.allContainer}`}>
