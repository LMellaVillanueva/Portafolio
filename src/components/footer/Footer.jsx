            ...
            <footer id='contacto' className='flex flex-col py-10 items-center  bottom-0 w-full h-full bg-gradient-to-b from-black to-gray-950'>
                ...
                <div className='flex flex-col lg:flex-row h-full w-full gap-10 lg:gap-0 justify-around items-center'>
                    <form onSubmit={sendEmail} className={`flex w-full lg:w-2/5 h-full flex-col items-start justify-start gap-2 p-8 ${styles.label}`}>
                        ...
                        <input type="text" name="from_name" onChange={handleChange} className={`bg-purple-950 border-b-2 border-purple-500 rounded-sm w-1/2 font-sans bg-gradient-to-b from-gray-900 to-purple-950 `} />
                        <label className={`font-sans text-xl ${styles.label}`}>Email</label>
                        <input type="email" name="from_email" onChange={handleChange} className={`bg-purple-950 border-b-2 border-purple-500 rounded-sm w-1/2 font-sans bg-gradient-to-b from-gray-900 to-purple-950 `} />
                        <label className={`font-sans text-xl ${styles.label}`}>Mensaje</label>
                        <textarea name="message" onChange={handleChange} className={`bg-purple-950 border-b-2 border-purple-500 rounded-sm w-full font-sans bg-gradient-to-b from-gray-900 to-purple-950 `} />
